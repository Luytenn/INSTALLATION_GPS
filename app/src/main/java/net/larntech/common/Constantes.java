...
public class Constantes {
    ...
    public static final String PREF_IMEI_GPS  = "PREF_IMEI_GPS";
    public static final String PREF_MODEL_GPS = "PREF_MODEL_GPS";
    public static final String PREF_ID_GPS = "PREF_ID_GPS";
